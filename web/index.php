        ...
        <div class="row g-4">
          <div class="col-lg-4 col-md-6">
            <div class="card h-100 shadow-sm">
              ...
              />
              <div class="card-body">
                <h5 class="card-title text-primary">Cardiovascular</h5>
                <p class="card-text">
                ...
                <ul class="list-unstyled">
                  <li>
                    <i class="bi bi-check-circle text-success me-2"></i>Heart
                    Disease Treatment
                  </li>
                  <li>
                    <i class="bi bi-check-circle text-success me-2"></i>Blood
                    Pressure Management
                  </li>
                  <li>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card h-100 shadow-sm">
              ...
              />
              <div class="card-body">
                <h5 class="card-title text-primary">Oncology</h5>
                <p class="card-text">
                  Innovative cancer treatments and therapies for various types
                  of cancer.
                </p>
                <ul class="list-unstyled">
                  <li>
                    <i class="bi bi-check-circle text-success me-2"></i>Targeted
                    Therapy
                  </li>
                  <li>
                    <i class="bi bi-check-circle text-success me-2"></i
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card h-100 shadow-sm">
              ...
              />
              <div class="card-body">
                <h5 class="card-title text-primary">Respiratory</h5>
                <p class="card-text">
                ...
                <ul class="list-unstyled">
                  <li>
                    <i class="bi bi-check-circle text-success me-2"></i>Asthma
                    Treatment
                  </li>
                  <li>
                    <i class="bi bi-check-circle text-success me-2"></i>COPD
                    Management
                  </li>
                  <li>
                    <i class="bi bi-check-circle text-success me-2"></i>Allergy
                    Relief
                  </li>
                </ul>
              </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card h-100 shadow-sm">
              ...
              />
              <div class="card-body">
                <h5 class="card-title text-primary">Diabetes Care</h5>
                <p class="card-text">
                  Complete diabetes management solutions and blood glucose
                  control.
                </p>
                <ul class="list-unstyled">
                  <li>
                    <i class="bi bi-check-circle text-success me-2"></i>Insulin
                    Therapy
                  </li>
                  <li>
                    <i class="bi bi-check-circle text-success me-2"></i>Blood
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
            ...
            <p class="lead mb-4">
              With over 50 years of experience in pharmaceutical innovation,
            ...
            <div class="row g-4">
              <div class="col-md-4">
                <div class="text-center p-4 bg-white rounded shadow-sm h-100">
                  ...
                  <p class="mb-0">
                    123 Pharma Boulevard<br />Medical District<br />New York, NY
                    10001
                  </p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="text-center p-4 bg-white rounded shadow-sm h-100">
                  ...
                  <p class="mb-0">
                    Main: +1 (555) 123-4567<br />Emergency: +1 (555) 987-6543<br />Fax:
                    +1 (555) 123-4568
                  </p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="text-center p-4 bg-white rounded shadow-sm h-100">
                  ...
                  <p class="mb-0">
                    info@pharmacare.com<br />support@pharmacare.com<br />media@pharmacare.com
                  </p>
                </div>
              </div>
            </div>
